...
export class UtxoRow extends LitElement {
  ...
  render() {
    return html`
      <div class="ml-1 text-s">
        <span class="text-s my-1 items-center">
          ${when(
            ...
            () =>
              html`<sl-tooltip content="Confirmed at block ${this.utxo?.status.block_height}">
                <sl-icon class="text-green-500" outline name="check-circle"></sl-icon>
              </sl-tooltip>`,
            () =>
              html` <sl-tooltip content="Unconfirmed">
          ...
          ${when(
            ...
            () =>
              html`<sl-tooltip content="Locked for ${this.utxo?.status.lock_blocks} blocks">
                <sl-icon class="text-red-500" outline name="lock"></sl-icon>
              </sl-tooltip>`,
            () =>
              html`<sl-tooltip content="Unlocked">
      ...
      <div class="ml-3 flex-auto w-20 text-xs">
